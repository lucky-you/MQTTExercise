package com.zhowin.mqttexercise.base;
...
import com.zhowin.mqttexercise.activity.MainActivity;
...
public abstract class BaseLibActivity extends SupportActivity implements View.OnClickListener {
    ...
    public void initImmersionBar() {
        ImmersionBar.with(this)
                ...
                .statusBarColor(com.zhowin.base_library.R.color.color_FFDE00)
                .keyboardEnable(true)
    ...
    public LoadProgressDialog showLoadDialog() {
        return showLoadDialog(mContext.getString(com.zhowin.base_library.R.string.Loading));
    }
    ...
    public LoadProgressDialog showLoadDialog(String hitMessage) {
        if (progressDialog == null) {
            ...
            if (TextUtils.isEmpty(hitMessage)) {
                progressDialog = progressDialog.createLoadingDialog(mContext.getString(com.zhowin.base_library.R.string.Loading));
            } else {
